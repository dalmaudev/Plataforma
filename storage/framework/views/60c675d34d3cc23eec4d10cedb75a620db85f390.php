<?php $__env->startSection('title', 'Mostrar Cliente'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title">
                <a href="<?php echo e(route('cliente.edit', $cliente->id)); ?>"><i class="fas fa-edit"></i></a>
                Mostrar Cliente




                <a class="btn btn-primary btn-sm" href="<?php echo e(route('consulta.show', $cliente->id)); ?>"><i
                        class="fas fa-swatchbook"></i>
                    Control de Consulta <span class="badge badge-light"></span></a>

                <a class="btn btn-success btn-sm" href="<?php echo e(route('editaproceso', $cliente->id)); ?>"><i
                        class="fas fa-balance-scale"></i>
                    Crear Proceso</a>

                <a class="btn btn-warning btn-sm" href="<?php echo e(route('editaler', $cliente->id)); ?>"><i class="far fa-bell"></i>
                    Crear Alerta</a>
            </h3>
        </div>
        <?php
        ...
        <div class="card-body">
                ...
                <?php for($i = 0; $i < $count; $i++): ?>
                    <li class="nav-item">
                        <a class="nav-link" id="custom-content-below-messages-tab" data-toggle="pill"
                            href="#n<?php echo e($pid[$i]); ?>" role="tab" aria-controls="custom-content-below-messages"
                            aria-selected="false"><?php echo e($TipodeProceso[$i]); ?></a>
                    </li>
                <?php endfor; ?>
                <li class="nav-item">
                    <a class="nav-link" id="custom-content-below-profile-tab" data-toggle="pill"
            ...
            <div class="tab-content" id="custom-content-below-tabContent">
                <div class="tab-pane fade show active" id="custom-content-below-home" role="tabpanel"
                    ...
                    <?php echo Form::model($cliente, ['route' => ['cliente.update', $cliente], 'method' => 'PUT']); ?>


                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <small><?php echo Form::label('nombre', 'Nombre Completo'); ?></small>
                            <?php echo Form::text('nombre', null, ['class' => 'form-control', 'readonly']); ?>

                        </div>
                        <div class="form-group col-md-6">
                            <small><?php echo Form::label('apellido', 'Apellido Completo'); ?> </small>
                            <?php echo Form::text('apellido', null, ['class' => 'form-control', 'readonly']); ?>

                        </div>
                    </div>
                    <div class="form-group">
                        <small><?php echo Form::label('direccion', 'Dirección'); ?></small>
                        <?php echo Form::text('direccion', null, ['class' => 'form-control', 'readonly']); ?>

                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-2">
                            <small><?php echo Form::label('provicia_id', 'Provicia'); ?> </small>
                            <?php echo Form::select('provincia_id', $provincia, null, ['class' => 'form-control mb-2', 'readonly']); ?>

                        </div>
                        <div class="form-group col-md-2">
                            <small><?php echo Form::label('localidad', 'Localidad'); ?> </small>
                            <?php echo Form::select('localidad_id', $localidades, null, ['class' => 'form-control mb-2', 'readonly']); ?>

                        </div>
                        <div class="form-group col-md-2">
                            <small><?php echo Form::label('cp', 'C.P.'); ?></small>
                            <?php echo Form::text('cp', null, ['class' => 'form-control', 'readonly']); ?>

                        </div>
                        <div class="form-group col-md-2">
                            <small><?php echo Form::label('documento', 'Tipo Documento'); ?> </small>
                            <?php echo Form::select('documento_id', $documentos, null, ['class' => 'form-control mb-2', 'readonly']); ?>

                        </div>
                        <div class="form-group col-md-2">
                            <small><?php echo Form::label('documento', 'Nº Documento'); ?> </small>
                            <?php echo Form::text('documento', null, ['class' => 'form-control', 'readonly']); ?>

                        </div>
                        <div class="form-group col-md-2">
                            <small><?php echo Form::label('caducidaddoc', 'Fecha Caducidad Documento'); ?> </small>
                            <?php echo Form::date('caducidaddoc', null, ['class' => 'form-control', 'readonly']); ?>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-2">
                            ...
                            <?php echo Form::select('pais_id', $paises, null, ['class' => 'form-control mb-2', 'readonly']); ?>

                        </div>
                        <div class="form-group col-md-2">
                            <small><?php echo Form::label('telefono', 'Telefono'); ?> </small>
                            <?php echo Form::text('telefono', null, ['class' => 'form-control', 'readonly']); ?>

                        </div>
                        <div class="form-group col-md-2">
                            <small><?php echo Form::label('email', 'Correo Electronico'); ?> </small>
                            <?php echo Form::text('email', null, ['class' => 'form-control', 'readonly']); ?>

                        </div>
                        <div class="form-group col-md-2">
                            <small><?php echo Form::label('estadocivil_id', 'Estado Civil'); ?> </small>
                            <?php echo Form::select('estadocivil_id', $estadocivil, null, ['class' => 'form-control mb-2', 'readonly']); ?>

                        </div>
                        <div class="form-group col-md-2">
                            <small><?php echo Form::label('hijo', 'Hijos'); ?> </small>
                            <?php echo Form::selectRange('hijo', 0, 20, null, ['class' => 'form-control mb-2', 'readonly']); ?>

                        </div>
                        <div class="form-group col-md-2">
                            <small><?php echo Form::label('nombrepadre', 'Nombre del Padre'); ?> </small>
                            <?php echo Form::text('nombrepadre', null, ['class' => 'form-control', 'readonly']); ?>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <?php echo Form::text('nombremadre', null, ['class' => 'form-control', 'readonly']); ?>

                        </div>
                        <div class="form-group col-md-2">
                            <small><?php echo Form::label('fecnac', 'Fecha de Nacimiento'); ?> </small>
                            <?php echo Form::date('fecnac', null, ['class' => 'form-control', 'readonly']); ?>

                        </div>
                        <div class="form-group col-md-8">
                            <small><?php echo Form::label('observaciones', 'Observacion'); ?> </small>
                            <?php echo Form::text('observaciones', null, ['class' => 'form-control', 'readonly']); ?>
                    ...
                    <hr>
                    <a class="btn btn-warning btn-sm" href="<?php echo e(route('files.edit', $cliente->id)); ?>"><i
                                    ...
                                    <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a target="_blank" href="<?php echo e(route('files.show', $file->id)); ?>"
                                                    class="btn btn-sm"><?php echo e(substr($file->name, 11)); ?></a>
                                            </td>
                                            <td>
                                                <a target="_blank" href="<?php echo e(route('files.show', $file->id)); ?>"
                            ...
                            <div class="card-body">
                                <?php $__currentLoopData = $alertas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alerta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="card card-light card-outline">
                                        <div class="card-header">
                                            <h5 class="card-title"><?php echo e($alerta->titulo); ?></h5>
                                            <div class="card-tools">
                                                <form action="<?php echo e(route('alerta.destroy', $alerta->id)); ?>" method="POST"
                                                    class="formulario-eliminar">
                                                    <a href="#"
                                                        class="btn btn-tool btn-link"><?php echo \Carbon\Carbon::parse($alerta->fecalert)->format('d-m-Y'); ?></a>
                                                    ...
                                                    <a href="<?php echo e(route('alerta.edit', $alerta->id)); ?>"
                                                        class="btn btn-tool">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="formularioEx" class="form-control" onchange="console.log('PDF seleccionado:', this.value)">
                                        ...
                                        <?php $__currentLoopData = $pdfs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pdf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($pdf); ?>"><?php echo e($pdf); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                ...
                <?php for($i = 0; $i < $count; $i++): ?>
                    <div class="tab-pane fade" id="n<?php echo e($pid[$i]); ?>" role="tabpanel"
                        aria-labelledby="n<?php echo e($pid[$i]); ?>-tab">
                        <a class="btn btn-danger btn-sm  float-right" title="Editar"
                            href="<?php echo e(route('procesocliente.edit', $pid[$i])); ?>"><i class="fa fa-pen"></i></a>
                        <div class="form-row mt-2">
                            <div class="form-group col-md-2">
                                <small><?php echo Form::label('tipoproceso_id', 'Proceso: '); ?> </small>
                            </div>
                            <div class="col-md-10">
                                <strong><?php echo e($Proceso[$i]); ?></strong>
                            </div>
                            ...
                            <div class="col-md-10">
                                <strong><?php echo e($TipodeProceso[$i]); ?></strong>
                            </div>
                            ...
                            <div class="col-md-10">
                                ...
                                <strong><?php echo \Carbon\Carbon::parse($FechaPresentacionProceso[$i])->format('d-m-Y'); ?></strong>
                            </div>

                            <div class="form-group col-md-2">
                                <small><?php echo Form::label('EstadoProceso', 'Estado del Proceso'); ?> </small>
                            </div>
                            <div class="col-md-10">
                                <strong><?php echo e($EstadodelProceso[$i]); ?></strong>
                            </div>

                            <div class="form-group col-md-2">
                                <small><?php echo Form::label('FechaDesicionProceso', 'Fecha Desición Proceso'); ?> </small>
                            </div>
                            <div class="col-md-10">
                                <strong><?php echo \Carbon\Carbon::parse($FechaDesicionProceso[$i])->format('d-m-Y'); ?></strong>
                            </div>
                            ...
                            <div class="col-md-10">
                                <strong><?php echo e($Especialista[$i]); ?></strong>
                            </div>

                            <div class="form-group col-md-2">
                                <small><?php echo Form::label('PagodelaConsulta', 'Pago de la Consulta'); ?> </small>
                            </div>
                            <div class="col-md-10">
                                <strong><?php echo e($PagodelaConsulta[$i]); ?></strong>
                            </div>

                            <div class="form-group col-md-2">
                                <small><?php echo Form::label('ValorProceso', 'Valor Proceso'); ?> </small>
                            </div>
                            <div class="col-md-10">
                                <strong><?php echo e($ValorProceso[$i]); ?></strong>
                            </div>
                            ...
                            <div class="col-md-10">
                                <strong><?php echo e($abono[$i]); ?></strong>
                            </div>

                            <div class="form-group col-md-2">
                                <small><?php echo Form::label('abono', 'Pendiente'); ?> </small>
                            </div>
                            <div class="col-md-10">
                                <strong><?php echo e($Pendiente[$i]); ?></strong>
                            </div>
                            ...
                            <div class="col-md-10">
                                <strong><?php echo e($Observaciones[$i]); ?></strong>
                            </div>
                        </div>
                        <hr>
                        <a class="btn btn-warning btn-sm" href="<?php echo e(route('docuproceso.show', $idem[$i])); ?>"><i
                                class="fas fa-upload"></i>
                            Subir Documentación <?php echo e($TipodeProceso[$i]); ?></a>
                        <div class="tab-custom-content">
                            <?php $__currentLoopData = $docuproceso; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $docu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($docu->procesocliente_id == $pid[$i]): ?>
                                    
                                    <a href="<?php echo e(route('docuproceso.edit', $docu->id)); ?>" target="_blank" type="button"
                                        class="btn btn-secondary btn-sm btn-block"><?php echo e(substr($docu->name, 11)); ?></a>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            async function fillFormByTemplate(pdfUrl) {
                try {
                    ...
                    if (formType === 'EX00 - Formulario_estancia.pdf') {
                        ...
                        const tipoDoc = <?php echo e($cliente->documento_id); ?>;
                        const documento = '<?php echo e($cliente->documento); ?>';
                        const apellidos = '<?php echo e($cliente->apellido); ?>'.split(' ');
                        const fechaNac = '<?php echo e($cliente->fecnac); ?>'.split('-');
                        const nacionalidad = '<?php echo e($cliente->pais->nombre); ?>';
                        ...
                        form.getTextField('Textfield-3').setText('<?php echo e($cliente->nombre); ?>');
                        ...
                        form.getTextField('Textfield-8').setText('<?php echo e($cliente->nombrepadre); ?>');
                        form.getTextField('Piso').setText('<?php echo e($cliente->nombremadre); ?>');
                        form.getTextField('CP').setText('<?php echo e($cliente->direccion); ?>');
                        form.getTextField('Textfield-12').setText('<?php echo e($cliente->localidad->nombre); ?>');
                        form.getTextField('Textfield-13').setText('<?php echo e($cliente->cp); ?>');
                        form.getTextField('Textfield-15').setText('<?php echo e($cliente->provincia->nombre); ?>');
                        form.getTextField('Textfield-17').setText('<?php echo e($cliente->telefono); ?>');
                        form.getTextField('D NIN IEPAS').setText('<?php echo e($cliente->email); ?>');
                        ...
                        form.getTextField('Nombre y apellidos del titular').setText('<?php echo e($cliente->nombre); ?> <?php echo e($cliente->apellido); ?>');
                        ...
                        form.getTextField('Lugar').setText('<?php echo e($cliente->nombre); ?>');
                        ...
                        form.getTextField('Textfield-10').setText('<?php echo e($cliente->nombrepadre); ?>');
                        form.getTextField('Piso').setText('<?php echo e($cliente->nombremadre); ?>');
                        
                        form.getTextField('Textfield-11').setText('<?php echo e($cliente->direccion); ?>');
                        form.getTextField('Email').setText('<?php echo e($cliente->localidad->nombre); ?>');
                        form.getTextField('Textfield-16').setText('<?php echo e($cliente->cp); ?>');
                        form.getTextField('Textfield-17').setText('<?php echo e($cliente->provincia->nombre); ?>');
                        form.getTextField('Textfield-19').setText('<?php echo e($cliente->telefono); ?>');
                        form.getTextField('Textfield-22').setText('<?php echo e($cliente->email); ?>');
                        ...
                        form.getTextField('Textfield-5').setText(nacionalidad);
                        form.getTextField('Textfield-8').setText(nacionalidad);
                        form.getTextField('Textfield-9').setText('<?php echo e($cliente->nombrepadre); ?>');
                        form.getTextField('Piso').setText('<?php echo e($cliente->nombremadre); ?>');
                        form.getTextField('CP').setText('<?php echo e($cliente->direccion); ?>');
                        form.getTextField('Textfield-13').setText('<?php echo e($cliente->localidad->nombre); ?>');
                        form.getTextField('Textfield-15').setText('<?php echo e($cliente->cp); ?>');
                        form.getTextField('Textfield-16').setText('<?php echo e($cliente->provincia->nombre); ?>');
                        form.getTextField('Textfield-17').setText('<?php echo e($cliente->telefono); ?>');
                        form.getTextField('Textfield-19').setText('<?php echo e($cliente->email); ?>');
                        ...
                        try {
                            ...
                            form.getTextField('Textfield-11').setText('<?php echo e($cliente->nombrepadre); ?>');
                            form.getTextField('Piso').setText('<?php echo e($cliente->nombremadre); ?>');
                            form.getTextField('Textfield-12').setText('<?php echo e($cliente->direccion); ?>');
                            form.getTextField('Email').setText('<?php echo e($cliente->localidad->nombre); ?>');
                            form.getTextField('Textfield-15').setText('<?php echo e($cliente->cp); ?>');
                            form.getTextField('Textfield-16').setText('<?php echo e($cliente->provincia->nombre); ?>');
                            form.getTextField('Textfield-17').setText('<?php echo e($cliente->telefono); ?>');
                        ...
                        try {
                            ...
                            form.getTextField('x').setText(apellidos[1] || '');
                            form.getTextField('Textfield-5').setText('<?php echo e($cliente->nombre); ?>');
                            ...
                            // Datos de contacto
                            form.getTextField('Provincia').setText('<?php echo e($cliente->direccion); ?>');
                            form.getTextField('Textfield-14').setText('<?php echo e($cliente->localidad->nombre); ?>');
                            form.getTextField('Textfield-16').setText('<?php echo e($cliente->cp); ?>');
                            form.getTextField('Textfield-17').setText('<?php echo e($cliente->provincia->nombre); ?>');
                            form.getTextField('Textfield-19').setText('<?php echo e($cliente->telefono); ?>');
                            form.getTextField('Textfield-21').setText('<?php echo e($cliente->email); ?>');
                        ...
                        try {
                            ...
                            form.getTextField('x').setText(apellidos[1] || '');
                            form.getTextField('Textfield-4').setText('<?php echo e($cliente->nombre); ?>');
                            ...
                            form.getTextField('Textfield-16').setText('<?php echo e($cliente->provincia->nombre); ?>');
                            form.getTextField('Provincia').setText('<?php echo e($cliente->direccion); ?>');
                            form.getTextField('Textfield-18').setText('<?php echo e($cliente->telefono); ?>');
                            form.getTextField('DN IN IEPAS').setText('<?php echo e($cliente->email); ?>');
                        ...
                        try {
                            ...
                            form.getTextField('Textfield-6').setText('<?php echo e($cliente->nombre); ?>');
                            ...
                            // Datos familiares
                            form.getTextField('Textfield-12').setText('<?php echo e($cliente->nombrepadre); ?>');
                            form.getTextField('Piso').setText('<?php echo e($cliente->nombremadre); ?>');
                            
                            // Dirección y contacto
                            form.getTextField('Provincia').setText('<?php echo e($cliente->direccion); ?>');
                            form.getTextField('Textfield-12').setText('<?php echo e($cliente->nombrepadre); ?>');
                            form.getTextField('Textfield-15').setText('<?php echo e($cliente->localidad->nombre); ?>');
                            form.getTextField('Textfield-17').setText('<?php echo e($cliente->cp); ?>');
                            form.getTextField('Textfield-19').setText('<?php echo e($cliente->provincia->nombre); ?>');
                            form.getTextField('Textfield-20').setText('<?php echo e($cliente->telefono); ?>');
                            form.getTextField('DN IN IEPAS').setText('<?php echo e($cliente->email); ?>');
                        ...
                        try {
                            ...
                            // Datos familiares
                            form.getTextField('Textfield-10').setText('<?php echo e($cliente->nombrepadre); ?>');
                            form.getTextField('N').setText('<?php echo e($cliente->nombremadre); ?>');
                        ...
                        try {
                            ...
                            const fieldValues = {
                                'Text1': '<?php echo e($cliente->nombre); ?>',                    // T0 nombre
                                'Text2': apellidos[0] || '',                         // T1 primer apellido
                                'Text4': apellidos[1] || '',                         // T2 segundo apellido
                                'Text5': '<?php echo e($cliente->pais->nombre); ?>',             // T3 nacionalidad
                                ...
                                'Text11': '<?php echo e($cliente->localidad->nombre); ?>',       // T9 localidad
                                'Text13': '<?php echo e($cliente->pais->nombre); ?>',            // T10 pais
                                'Text14': '<?php echo e($cliente->nombrepadre); ?>',             // T11 nombre padre
                                'Text18': '<?php echo e($cliente->nombremadre); ?>',             // T15 nombre madre
                                'Text20': '<?php echo e($cliente->direccion); ?>',               // T16 direccion
                                'Text15': '<?php echo e($cliente->localidad->nombre); ?>',       // T12 localidad
                                'Text24': '<?php echo e($cliente->cp); ?>',                      // T20 cp
                                'Text23': '<?php echo e($cliente->provincia->nombre); ?>',       // T19 provincia
                                'Text17': '<?php echo e($cliente->telefono); ?>',                // T14 telefono
                                'Text16': '<?php echo e($cliente->email); ?>',                   // T13 email
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\Plataforma\resources\views/cliente/show.blade.php ENDPATH**/ ?>