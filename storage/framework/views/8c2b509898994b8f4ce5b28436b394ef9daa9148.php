...
<script type="text/javascript" src="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.23/b-1.6.5/b-html5-1.6.5/b-print-1.6.5/datatables.min.js"></script>
    ...
    <script>
      ...
      $('#proc').DataTable( {
        "ajax": "<?php echo e(route('afiliados.clients')); ?>",
        "columns":[
            {data: 'id'},
            {data: 'nombre'},
            {data: 'apellido'},
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\Plataforma\resources\views/cliente/afiliado.blade.php ENDPATH**/ ?>