...
<div class="container ">
    <div>
                ...
                <table class="table table-bordered table-sm" id="contenidoTabla">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><small class="text-uppercase"><?php echo e($cliente->nombre); ?>

                                    <?php echo e($cliente->apellido); ?></small> </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><small class="text-uppercase"><?php echo e($cliente->cp); ?>,
                                    <?php echo e($cliente->localidad->nombre); ?> /
                                    <?php echo e($cliente->provincia->nombre); ?></small> </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><small class="text-uppercase"><?php echo e($cliente->pais->nombre); ?></small> </td>
                        </tr>
                        <tr>
                            <td><small>ESTADO CIVIL</small> </td>
                            <td><small class="text-uppercase"><?php echo e($cliente->estadocivil->nombre); ?></small>
                            </td>
                        </tr>
                        <tr>
                            <?php
                    ...
                    <tr>
                        ...
                        <td><small class="text-uppercase">Padre: <?php echo e($cliente->nombrepadre); ?>, Madre:
                                <?php echo e($cliente->nombremadre); ?></small> </td>
                    </tr>
                    <tr>
                        <td><small>FECHA DE NACIMIENTO</small> </td>
                        <td><small><?php echo \Carbon\Carbon::parse($cliente->fecnac)->format('d-m-Y'); ?></small> </td>
                    </tr>
                    <tr>
                        <td><small>PROFESION</small> </td>
                        <td><small class="text-uppercase"><?php echo e($cliente->profesion); ?></small> </td>
                    </tr>
                    <tr>
                        <td><small>COMO NOS CONOCIÓ</small> </td>
                        <td><small class="text-uppercase"><?php echo e($cliente->conocio); ?></small> </td>
                    </tr>
                    <tr>
                        <td><small>OBSERVACIÓN</small> </td>
                        <td><small class="text-uppercase"><?php echo e($cliente->observaciones); ?></small> </td>
                    </tr>
               </tbody>
            </table>
        ...
        <div class="row justify-content-center">
          ...
          <center>
              <a href="<?php echo e(route('signaturepad.edit', $cliente)); ?>" type="button" class="btn btn-success">Firma Documento</a>
          </center>
...
<?php /**PATH F:\xampp\htdocs\Plataforma\resources\views/signature_pad.blade.php ENDPATH**/ ?>