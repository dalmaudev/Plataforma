...
<img src="<?php echo e(public_path('/archivo/logo.jpg')); ?>" width="64px" alt="" class="float-right" ><br>
<p></p>
    ...
    <br>
        <?php if($cliente->numseguridad == null): ?>
          <h4>FICHA DEL CLIENTE</h4>
          <table class="table table-bordered table-sm" id="contenidoTabla">
            <tbody>
              <tr>
                <td>FECHA </td>
                <td><strong><?php echo \Carbon\Carbon::parse($cliente->created_at)->format('d-m-Y'); ?></strong> </td>
              </tr>
              <tr>
                <td>NOMBRE Y APELLIDOS  </td>
                <td class="text-uppercase"><strong><?php echo e($cliente->nombre); ?> <?php echo e($cliente->apellido); ?></strong>  </td>
              </tr>
              <tr>
                <td>DIRECCION</td>
                <td class="text-uppercase"><strong><?php echo e($cliente->direccion); ?> </strong> </td>
              </tr>
              <tr>
                  <td>CIUDAD/LOCALIDAD Y PROVINCIA  </td>
                  <td class="text-uppercase"><strong> <?php echo e($cliente->cp); ?>, <?php echo e($cliente->localidad->nombre); ?> / <?php echo e($cliente->provincia->nombre); ?></strong></td>
              </tr>
              <tr>
                  <td><?php echo e($cliente->document->nombre); ?>  </td>
                  <td class="text-uppercase"><strong><?php echo e($cliente->documento); ?></strong>  </td>
              </tr>
              <tr>
                  <td>TELEFONO  </td>
                  <td><strong><?php echo e($cliente->telefono); ?> </strong> </td>
              </tr>
              <tr>
                  <td>CORREO ELECTRONICO  </td>
                  <td><strong><?php echo e($cliente->email); ?> </strong></td>
              </tr>
              <tr>
                  <td>NACIONALIDAD  </td>
                  <td class="text-uppercase"><strong><?php echo e($cliente->pais->nombre); ?> </strong></td>
              </tr>
              <tr>
                  <td>ESTADO CIVIL </td>
                  <td class="text-uppercase"><strong><?php echo e($cliente->estadocivil->nombre); ?> </strong></td>
              </tr>
              <tr>
                <?php
                    $totalhijos = 0;
                ?>
                  ...
                  <?php endif; ?>
                  <td>
                    <?php if($totalhijos == '' || $totalhijos == 0): ?>
                  <strong>SIN HIJOS</strong>
                    <?php else: ?>
                      <?php if($totalhijos == 1): ?>
                      <?php echo e($totalhijos); ?>  HIJO, EDAD:  <?php echo e($cliente->hijo1); ?>

                      <?php else: ?>
                        <?php echo e($totalhijos); ?>  HIJOS, EDADES:
                        <?php for($i = 1; $i <= $totalhijos; $i++): ?>
                      <strong><?php echo e($cliente->{'hijo'.$i}); ?></strong> ,
                        <?php endfor; ?>
                      <?php endif; ?>
                    <?php endif; ?>
                     </td>
              ...
              <tr>
                  ...
                  <td class="text-uppercase"><strong>Padre: <?php echo e($cliente->nombrepadre); ?>, Madre: <?php echo e($cliente->nombremadre); ?></strong> </td>
              </tr>
              <tr>
                  <td>FECHA DE NACIMIENTO </td>
                  <td><strong><?php echo \Carbon\Carbon::parse($cliente->fecnac)->format('d-m-Y'); ?></strong> </td>
              </tr>
              <tr>
                <td>PROFESION  </td>
                <td class="text-uppercase"><strong><?php echo e($cliente->profesion); ?> </strong></td>
            </tr>
            <tr>
              <td>COMO NOS CONOCIÓ  </td>
              <td class="text-uppercase"><strong><?php echo e($cliente->conocio); ?> </strong></td>
          </tr>
          <tr>
            <td>OBSERVACIÓN  </td>
            <td class="text-uppercase"><strong><?php echo e($cliente->observaciones); ?> </strong></td>
        </tr>
            </tbody>
          </table>
          <br><br>

        <?php if($cliente->firmado != ''): ?>
        <div>
          <center>
          <img src="<?php echo e(public_path('/upload/'.$cliente->firmado)); ?>" width="250px"  ><br>
          </center>
...
Finalmente, todo lo declarado se insta en cumplimiento del Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo, de 27 de abril de 2016, relativo a la protección de las personas físicas en lo que respecta al tratamiento de datos personales y a la libre circulación de estos datos y por el que se deroga la Directiva 95/46/CE (Reglamento general de protección de datos).<br><br>
  ...
  <?php else: ?>
        ...
        <table class="table table-bordered table-sm" id="contenidoTabla">
          <tbody>
            <tr>
              ...
              <td><small><?php echo \Carbon\Carbon::parse($cliente->created_at)->format('d-m-Y'); ?></small></td>
            </tr>
            <tr>
              <td><small>NOMBRE Y APELLIDOS</small>  </td>
              <td><small class="text-uppercase"><?php echo e($cliente->nombre); ?> <?php echo e($cliente->apellido); ?></small> </td>
            </tr>
            <tr>
              <td><small>DIRECCION</small> </td>
              <td><small class="text-uppercase"><?php echo e($cliente->direccion); ?></small> </td>
            </tr>
            <tr>
                <td><small>CIUDAD/LOCALIDAD Y PROVINCIA</small>  </td>
                <td><small class="text-uppercase"><?php echo e($cliente->cp); ?>, <?php echo e($cliente->localidad->nombre); ?> / <?php echo e($cliente->provincia->nombre); ?></small> </td>
            </tr>
            <tr>
              <td><small>DOMICILIO FISCAL</small> </td>
              <td><small class="text-uppercase"><?php echo e($cliente->domifiscal); ?></small> </td>
            </tr>
            <tr>
                <td><small><?php echo e($cliente->document->nombre); ?></small>  </td>
                <td><small class="text-uppercase"><?php echo e($cliente->documento); ?></small> </td>
            </tr>
            <tr>
                <td><small>TELEFONO</small>  </td>
                <td><small><?php echo e($cliente->telefono); ?></small> </td>
            </tr>
            <tr>
                <td><small>CORREO ELECTRONICO</small>  </td>
                <td><small ><?php echo e($cliente->email); ?></small> </td>
            </tr>
            <tr>
                <td><small>¿DISPONE DE CERTIFICADO DIGITAL?</small>  </td>
                <td><small class="text-uppercase"><?php echo e($cliente->certdigital); ?></small> </td>
            </tr>
            ...
            <tr>
                ...
                ?>
                <td><small class="text-uppercase"><?php echo e($resp); ?> </small> </td>
            </tr>


            <tr>
                <td><small>NUMERO DE SEGURIDAD SOCIAL</small>  </td>
                <td><small class="text-uppercase"><?php echo e($cliente->numseguridad); ?></small> </td>
            </tr>
            <tr>
                <td><small>CUENTA BANCARIA</small>  </td>
                <td><small><?php echo e($cliente->cuentabanco); ?></small> </td>
            </tr>
            <tr>
              <td><small>TITULAR DE LA CUENTA BANCARIA</small>  </td>
              <td><small class="text-uppercase"><?php echo e($cliente->titularbanco); ?></small> </td>
          </tr>
          </tbody>
        </table>
        <br><br>
        ...
        <img src="<?php echo e(asset('/archivo/logo.jpg')); ?>" width="64px" alt="" class="float-right" ><br>
        <p class="small"><small>Paseo de las delicias 20, 2ª Madrid 28045</small><br><small>912305907/658592584</small> </p>
        <br>
...
<?php /**PATH F:\xampp\htdocs\Plataforma\resources\views/cliente/pdf.blade.php ENDPATH**/ ?>