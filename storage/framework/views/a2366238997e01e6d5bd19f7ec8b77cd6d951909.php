...
<?php $__env->startSection('title', 'Asesoria | Procesos Cliente'); ?>

<?php $__env->startSection('content_header'); ?>
    <h1>Listado de los Procesos <a class="btn btn-dark btn-sm float-right" href="<?php echo e(route('procesocliente.create')); ?>">Crear Proceso Cliente</a></h1>
    <hr>
    <?php if(session('info')): ?>
...
<script type="text/javascript" src="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.23/b-1.6.5/b-html5-1.6.5/b-print-1.6.5/datatables.min.js"></script>
    ...
    <script>
      ...
      $('#proc').DataTable( {
        "ajax": "<?php echo e(route('docprocesoclientes.procesocliente')); ?>",
        "columns":[
            {data: 'id'},
            {data: 'tipoproceso'},
            {data: 'proceso'},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\Plataforma\resources\views/procesocliente/index.blade.php ENDPATH**/ ?>