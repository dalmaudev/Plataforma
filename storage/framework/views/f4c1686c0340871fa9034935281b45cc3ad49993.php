       ...
       <div class="col-md-12 mt-5">
           <div class="card">
               <div class="card-header">
                   <h5>Firma Documento : <?php echo e($cliente->nombre); ?> <?php echo e($cliente->apellido); ?></h5>
               </div>
               <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form method="POST" action="<?php echo e(route('signaturepad.store')); ?>">
                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH F:\xampp\htdocs\Plataforma\resources\views/firma/firmar.blade.php ENDPATH**/ ?>