...
@section('title', 'Asesoria | Recurso Cliente')

@section('content_header')
    <h1>Listado de los Recursos <a class="btn btn-dark btn-sm float-right" href="{{route('procesocliente.create')}}">Crear Proceso Cliente</a></h1>
    <hr>
    @if (session('info'))
...
<table id="proc" class="table table-striped table-bordered table-hover display nowrap" style="width:100%">
    <thead>
        <tr>
            ...
            <th width="10px"><small>Especialista</small> </th>
            <th width="10px"><small>FecPreRecurso</small> </th>
            <th width="10px"><small>Desicion Recurso</small> </th>
            <th width="1px"></th>
        </tr>
    </thead>
</table>
...
<script type="text/javascript" src="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.23/b-1.6.5/b-html5-1.6.5/b-print-1.6.5/datatables.min.js"></script>
    ...
    <script>
      ...
      $('#proc').DataTable( {
        "ajax": "{{route('docrecursoclientes.recursocliente')}}",
        "columns":[
             {data: 'id'},
            // {data: 'tipoproceso'},
            // {data: 'proceso'},
