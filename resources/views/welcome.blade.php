    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            <section class="hero container max-w-screen-lg mx-auto pb-10 flex justify-center">
                <img  src="{{asset('/archivo/asesoria.png')}}" alt="screenshot" >
            </section>
     ...
     <div class="container login__container my-1">
        <div class="row login__row">
            <div class="col-md-6 d-flex">
                <img class="login__imagek align-self-center" src="{{asset('/archivo/logo.jpg')}}"
                    width="70%" alt="" />
            </div>
                            ...
                            <div class="">
                                ...
                                @auth
                                        <div class="dropdown-divider my-4"></div>
                                            <a href="{{ url('/dashboard') }}" class="btn btn-primary btn-lg btn-block my-3"> Dashboard</a>
                                @else
                                        <div class="form-group">
                                            <div class="dropdown-divider my-4"></div>
                                            <a href="{{ route('login') }}" class="btn btn-primary btn-lg btn-block my-3"> Ingresar</a>
                                        </div>
                                @endauth
                                    </div>
                                @endif               
