    ...
    <div class="container-fluid">
      <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title">Control de Llamadas: <strong>{{$querys->nombre}} {{$querys->apellido}} / {{$querys->telefono}}</strong></h3>
         ...
         <div class="card-body ">
          ...
          <div class="input-group">
            ...
            @error('fecllam')
                <span class="text-danger"><strong><small>{{ $message }}</small></strong></span><br>
            @enderror
            <input type="date" name="fecllam"   class="form-control" value="{{ $llamada->fecllam}}">
            <input type="text" name="consulta"  class="form-control" autofocus value="{{$llamada->consulta}}">
