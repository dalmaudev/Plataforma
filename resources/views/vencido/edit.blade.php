...
@section('content_header')
    <h1>Editar Cliente<a class="btn btn-success btn-sm float-right" href="{{route('cliente.index')}}"><i class="far fa-hand-point-left"></i> Volver</a></h1>
@stop
...
{!! Form::model($cliente, ['route' => ['cliente.update', $cliente],'method' => 'PUT','files' => true]) !!}
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-3">
           <small>{!! Form::label('foto', 'Imagen Documento') !!} </small><br>
            {!! Form::file('foto') !!}
          </div>
      </div>
      <div class="form-row">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-3">
          <small>{!! Form::label('fecnac', 'Fecha Caducidad Documento') !!} </small>
