...
@section('title', 'Asesoria | Localidades')

@section('content_header')
    <h1>Listado de Localidad
      
      @can('localidad.create')
        <a class="btn btn-dark btn-sm float-right" href="{{route('localidad.create')}}">Crear Localidad</a>
      @endcan
      </h1>
    <hr>
    @if (session('info'))
