...
return [
    ...
    */
    ...
    'title' => 'SSS ASESORIA & EXTRANJERIA',
    'title_prefix' => '',
    'title_postfix' => '',
    ...
    */
    ...
    'logo' => '<b><small>ASESORIA & EXTRANJERIA</small></b>',
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Control LLamadas',
            'route'  => 'llamada.index',
            'icon' => 'fa fa-fw fa-phone-volume',
        ...
        [
            'text' => 'Proceso',
            'route'  => 'procesocliente.index',
            'icon' => 'fa fa-fw fa-balance-scale',
            'can' => 'procesocliente.index',
        ],
        ...
        ['header' => 'NOTA'],
         ...
         [
            ...
            'route' => 'sends-mail.index',
            'icon' => 'fas fa-fw fa-envelope-open-text',
            'can' => 'sends-mail.index',
        ],
        ['header' => 'AJUSTES'],
        [
            'text' => 'Especialistas',
        ...
        [
            ...
            'can' => 'estadocivil.index',
        ],
        [
            'text' => 'Presento',
            'route'  => 'presento.index',
            'icon' => 'far fa-fw fa-file-powerpoint',
            'can' => 'presento.index',
        ],
        [
            'text' => 'Decisión',
            'route'  => 'desicion.index',
            'icon' => 'fas fa-fw fa-clipboard-list',
            // 'can' => 'desicion.index',
        ],
        [
            'text' => 'Tipo Cliente',
            'route'  => 'tipoclientes.index',
            'icon' => 'far fa-fw fa-file-powerpoint',
            // 'can' => 'presento.index',
        ],
        ...
        // [
        //     'text' => 'Tipo Proceso',
        //     'route'  => 'tipoproceso.index',
        //     'icon' => 'fas fa-fw fa-suitcase',
        //     'can' => 'tipoproceso.index',
        // ],
        [
            'text' => 'Sexo',
            'route'  => 'sexo.index',
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Precio Proceso',
                    'route'  => 'precioproceso.index',
                    // 'can' => 'precioproceso.index',
                    'icon' => 'fas fa-fw fa-hand-holding-usd',
                ],
            ],
        ],
